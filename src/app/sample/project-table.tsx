...
function SampleColumns(): ColumnDef<Sample>[] {
  return [
    {
      accessorKey: "name",
      header: "Name",
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            <Link
              href={`/sample/${sample.id}/edit`}
              title="Edit"
            >
              <u>Edit</u>
            </Link>
            <Link
              href={`/sample/${sample.id}/delete`}
              title="Delete"
            >
              <u>Delete</u>
            </Link>
...
function DefaultTable({ columns }: { columns: ColumnDef<Sample>[] }) {
  return (
    <TableRow>
